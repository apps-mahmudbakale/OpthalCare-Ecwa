...
@section('page-script')
    ...
    <script>
      $(document).ready(function () {
        console.log('Document ready, Swal available:', typeof Swal !== 'undefined');
        ...
        // Handle "Cancel System Charge" button with SweetAlert
        $(document).on('click', '.cancel-charge-btn', function (e) {
          ...
          console.log('Cancel button clicked!', {billingId, serviceName, swalAvailable: typeof Swal !== 'undefined'});
          
          // Check if Swal is available
          if (typeof Swal === 'undefined') {
            console.error('SweetAlert2 is not loaded!');
            if (confirm('Cancel charge for: ' + serviceName + '?\n\nThis action cannot be undone!')) {
              ...
              $.ajax({
                ...
                error: function(xhr) {
                  alert('Error: ' + (xhr.responseJSON?.message || 'Failed to cancel charge.'));
                }
              });
            }
            return;
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Failed to load payment form',
                        confirmButtonText: 'OK'
                    });
                }
            });
