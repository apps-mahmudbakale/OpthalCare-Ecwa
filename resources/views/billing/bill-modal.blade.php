...
<form action="{{ route('app.billing.store') }}" method="post">
    ...
    <div class="form-group">
        ...
        <div class="d-grid gap-2 col-lg-12 mt-3 mx-auto">
            <button id="first-timer" data-request-url="{{ route('app.patients.first-timer') }}" data-toggle="modal"
                data-target="#global-modal" class="btn btn-primary btn-lg waves-effect waves-light" type="button">New
                Bill</button>
        </div>
    </div>
