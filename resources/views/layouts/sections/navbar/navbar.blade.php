                    ...
                    <div class="row row-bordered overflow-visible g-0">
                        <div class="row row-bordered overflow-visible g-0">
                            <div class="dropdown-shortcuts-item col">
                                ...
                                <a href="{{ route('app.patients.create') }}" class="stretched-link">New Patient</a>
                                <small class="text-muted mb-0">Create New Patient</small>
                            </div>
                            <div class="dropdown-shortcuts-item col">
                                <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                    <i class="ti ti-users fs-4"></i>
                                </span>
                                <a href="{{ route('app.patients.index') }}" class="stretched-link">Patients</a>
                                <small class="text-muted mb-0">List Patients</small>
                            </div>
                        </div>
                        <div class="dropdown-shortcuts-item col">
                            <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                            ...
                            <a href="{{ route('app.appointments.index') }}" class="stretched-link">Appointments</a>
                            <small class="text-muted mb-0">Appointment Schedules</small>
                        </div>
                        <div class="dropdown-shortcuts-item col">
                            <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                <i class="ti ti-settings fs-4"></i>
                            </span>
                            <a href="{{ route('app.settings.index') }}" class="stretched-link">Setting</a>
                            <small class="text-muted mb-0">App Settings</small>
                        </div>
                    </div>
