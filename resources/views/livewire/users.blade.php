        ...
        <div class="card-header flex-column flex-md-row">
            ...
            <div class="dt-action-buttons text-end pt-3 pt-md-0">
                <div class="dt-buttons btn-group flex-wrap">
                    ...
                    <a class="btn btn-secondary create-new btn-primary" href="{{ route('app.users.create') }}"><span><i
                        ...
                        <td>
                            <div class="d-inline-block"><a href="javascript:;"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                    <li><a href="{{ route('app.users.edit', $user->id) }}"
                                            class="dropdown-item">Edit</a></li>
                                    <div class="dropdown-divider"></div>
                                    <li><a id="delete{{ $user->id }}"
                                            data-value="{{ $user->id }}"
                            ...
                            <form id="delete#{{ $user->id }}" action="{{ route('app.users.destroy', $user->id) }}"
