<div>
    ...
    <script>
        window.addEventListener('DrugCategoryEditModal', function() {
            var modal = new bootstrap.Modal(document.getElementById('editDrugCategoryModal'));
            modal.show();
        });
    </script>
</div>
@include('_partials._modals.modal-new-drugs-category')
@include('_partials._modals.modal-edit-drug-category')
