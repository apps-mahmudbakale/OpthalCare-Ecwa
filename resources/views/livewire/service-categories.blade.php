<div>
                        ...
                        <td>
                            <div class="d-inline-block"><a href="javascript:;"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                    ...
                                    <li><a id="delete{{ $category->id }}"
                                            data-value="{{ $category->id }}"
                                            class="dropdown-item text-danger delete-record">Delete</a></li>
                                </ul>
                            </div>
                            <script>
                                document.querySelector('#delete{{ $category->id }}').addEventListener('click', function(e) {
                            ...
                            <form id="delete#{{ $category->id }}" action="{{ route('app.categories.destroy', $category->id) }}"
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">
                    Showing {{ $categories->firstItem() }} to {{ $categories->lastItem() }}  of {{ $categories->total() }} entries</div>
            </div>
            <div class="col-sm-12 col-md-6">
   ...
   @include('_partials/_modals.modal-new-service')
   @include('_partials/_modals.modal-edit-service')
</div>
