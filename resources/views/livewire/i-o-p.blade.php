   ...
   <div class="card card-fluid">
     ...
     <div class="card-body">
       <table class="table">
         ...
         <tr>
           <td></td>
           <td>{{ $iop->created_at->format('d M Y h:i A') }}</td>
           <td>{{ $iop->user->firstname }} {{ $iop->user->lastname }}</td>
           <td>
             <div class="btn-group">
               ...
               <ul class="dropdown-menu" style="">
                 <l>
                   <button class="dropdown-item" data-request-url="{{route('app.show.iop', $iop->id)}}"
                           data-toggle="modal"
