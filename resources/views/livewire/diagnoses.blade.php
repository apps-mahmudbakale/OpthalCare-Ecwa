        ...
        <details class="accordion">
            ...
            <div class="accordion-content p-2">
                <div class="accordion-header mb-3">
                    <h3 class="mb-2">Record Encounter for {{ $diagnosis->patient->user->firstname }}
                        {{ $diagnosis->patient->user->lastname }}</h3>
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-icon btn-light waves-effect waves-light"
                            data-bs-toggle="dropdown" data-boundary="viewport" aria-expanded="false" aria-haspopup="true">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <button class="dropdown-item3  text-bg-danger" id="delete"
                                    data-delete-url="{{ route('app.diagnosis.destroy', $diagnosis->id) }}">Delete</button>
                            </li>
                        </ul>
                    </div>
                </div>
                <p class="text-muted">Recorded By {{ $diagnosis->user->firstname }} {{ $diagnosis->user->lastname }} on
                    {{ $diagnosis->created_at->format('d M Y h:i A') }}</p>
                        ...
                        <div class="list-group list-group-bordered">
                            <div class="list-group-header justify-content-between">
                                <div><i class="fas fa-calendar"></i>
                                    {{ $diagnosis->created_at->format('d M Y h:i A') }}</div>
                                <div><i class="fas fa-user"></i> {{ $diagnosis->user->firstname }}
                                    {{ $diagnosis->user->lastname }}</div>
                            </div>
