                ...
                @foreach ($stores as $store)
                    <tr class="odd">
                        ...
                        <td>
                            <div class="d-inline-block"><a href="javascript:;" class="dropdown hide-arrow"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                    <li><button type="button" 
                                            data-request-url="{{ route('app.drugs-store.edit', $store->id) }}"
                            ...
                            <script>
                                document.querySelector('#dele{{ $store->id }}').addEventListener('click', function(e) {
                            ...
                            <form id="dele#{{ $store->id }}"
                                action="{{ route('app.consulting-rooms.destroy', $store->id) }}" method="POST"
