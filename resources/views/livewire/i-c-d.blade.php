<div>
    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            ...
                            <div class="d-inline-block"><a href="javascript:;" class="dropdown hide-arrow"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                    <li><a href="javascript:void(0);"
                                           ...
                                           data-request-url="{{ route('app.icd.edit', $icd->id) }}">Edit</a></li>
                                    <div class="dropdown-divider"></div>
                                    <li><a href="javascript:void(0);" class="dropdown-item-delete text-danger"
                                            onclick="submitICDDeleteForm({{ $icd->id }})">Delete</a></li>
                                </ul>
                            </div>
                          <form id="delete-icd-{{ $icd->id }}"
                                action="{{ route('app.icd.destroy', $icd->id) }}"
                                method="POST"
                                style="display: none;"
                                wire:ignore>
                            @csrf
      ...
      <script>
        function submitICDDeleteForm(id) {
          if (confirm('Are you sure you want to delete this ICD?')) {
