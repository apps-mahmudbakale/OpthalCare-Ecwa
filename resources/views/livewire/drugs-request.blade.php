  ...
  <details class="accordion">
    ...
    <div class="accordion-content p-2">
      <div class="accordion-header mb-3">
        <h3 class="mb-2">Drug Prescription for {{ \App\Models\Patient::find($request->patient_id)->user->firstname }} {{ \App\Models\Patient::find($request->patient_id)->user->lastname }}</h3>
        <div class="btn-group">
