                        ...
                        <td>
                            <div class="d-inline-block"><a href="javascript:;" class="dropdown hide-arrow"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                    <li><a href="" wire:click.prevent="selectWard({{ $ward->id }})"
                                            class="dropdown-item">Edit</a></li>
                                    <div class="dropdown-divider"></div>
                                    <li><a id="delete{{ $ward->id }}" data-value="{{ $ward->id }}"
                                            class="dropdown-item text-danger delete-record">Delete</a></li>
                                </ul>
                            </div>
                            <script>
                                document.querySelector('#delete{{ $ward->id }}').addEventListener('click', function(e) {
                            ...
                            <form id="delete#{{ $ward->id }}" action="{{ route('app.wards.destroy', $ward->id) }}"
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">
                    Showing {{ $wards->firstItem() }} to {{ $wards->lastItem() }} of
                    {{ $wards->total() }} entries</div>
            </div>
            <div class="col-sm-12 col-md-6">
