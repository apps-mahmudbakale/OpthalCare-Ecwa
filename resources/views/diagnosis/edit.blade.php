            ...
            <div class="tab-pane fade" id="step2" role="tabpanel" aria-labelledby="step2-tab">
              ...
              <table class="table table-striped table-bordered">
                ...
                <tr>
                  ...
                  <td><input type="text" value="{{ old('uncorrected_right', isset($diagnosis) ? $diagnosis->uncorrected_right : '') }}" name="uncorrected_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('uncorrected_left', isset($diagnosis) ? $diagnosis->uncorrected_left : '') }}" name="uncorrected_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">PIN HOLE</td>
                  <td><input type="text" value="{{ old('pinhole_right', isset($diagnosis) ? $diagnosis->pinhole_right : '') }}" name="pinhole_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('pinhole_left', isset($diagnosis) ? $diagnosis->pinhole_left : '') }}" name="pinhole_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">VA WITH GLASSES</td>
                  <td><input type="text" value="{{ old('va_glass_right', isset($diagnosis) ? $diagnosis->va_glass_right : '') }}" name="va_glass_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('va_glass_left', isset($diagnosis) ? $diagnosis->va_glass_left : '') }}" name="va_glass_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">NEAR VISION</td>
                  <td><input type="text" value="{{ old('near_vision_right', isset($diagnosis) ? $diagnosis->near_vision_right : '') }}" name="near_vision_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('near_vision_left', isset($diagnosis) ? $diagnosis->near_vision_left : '') }}" name="near_vision_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">LID</td>
                  <td><input type="text" value="{{ old('lid_right', isset($diagnosis) ? $diagnosis->lid_right : '') }}" name="lid_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('lid_left', isset($diagnosis) ? $diagnosis->lid_left : '') }}" name="lid_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">GLOBE</td>
                  <td><input type="text" value="{{ old('globe_right', isset($diagnosis) ? $diagnosis->globe_right : '') }}" name="globe_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('globe_left', isset($diagnosis) ? $diagnosis->globe_left : '') }}" name="globe_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">EOMM</td>
                  <td><input type="text" value="{{ old('eomm_right', isset($diagnosis) ? $diagnosis->eomm_right : '') }}" name="eomm_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('eomm_left', isset($diagnosis) ? $diagnosis->eomm_left : '') }}" name="eomm_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">CONJUNCTIVA</td>
                  <td><input type="text" value="{{ old('conjuctiva_right', isset($diagnosis) ? $diagnosis->conjuctiva_right : '') }}" name="conjuctiva_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('conjuctiva_left', isset($diagnosis) ? $diagnosis->conjuctiva_left : '') }}" name="conjuctiva_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">CORNEA</td>
                  <td><input type="text" value="{{ old('cornea_right', isset($diagnosis) ? $diagnosis->cornea_right : '') }}" name="cornea_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('cornea_left', isset($diagnosis) ? $diagnosis->cornea_left : '') }}" name="cornea_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">ANTERIOR CHA</td>
                  <td><input type="text" value="{{ old('anterior_cha_right', isset($diagnosis) ? $diagnosis->anterior_cha_right : '') }}" name="anterior_cha_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('anterior_cha_left', isset($diagnosis) ? $diagnosis->anterior_cha_left : '') }}" name="anterior_cha_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">IRIS</td>
                  <td><input type="text" value="{{ old('iris_right', isset($diagnosis) ? $diagnosis->iris_right : '') }}" name="iris_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('iris_left', isset($diagnosis) ? $diagnosis->iris_left : '') }}" name="iris_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">PUPIL</td>
                  <td><input type="text" value="{{ old('pupil_right', isset($diagnosis) ? $diagnosis->pupil_right : '') }}" name="pupil_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('pupil_left', isset($diagnosis) ? $diagnosis->pupil_left : '') }}" name="pupil_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">LENS</td>
                  <td><input type="text" value="{{ old('lens_right', isset($diagnosis) ? $diagnosis->lens_right : '') }}" name="lens_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('lens_left', isset($diagnosis) ? $diagnosis->lens_left : '') }}" name="lens_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">IOP</td>
                  <td><input type="text" value="{{ old('iop_right', isset($diagnosis) ? $diagnosis->iop_right : '') }}" name="iop_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('iop_left', isset($diagnosis) ? $diagnosis->iop_left : '') }}" name="iop_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">VITREOUS</td>
                  <td><input type="text" value="{{ old('vitreous_right', isset($diagnosis) ? $diagnosis->vitreous_right : '') }}" name="vitreous_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('vitreous_left', isset($diagnosis) ? $diagnosis->vitreous_left : '') }}" name="vitreous_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">DISC</td>
                  <td><input type="text" value="{{ old('disc_right', isset($diagnosis) ? $diagnosis->disc_right : '') }}" name="disc_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('disc_left', isset($diagnosis) ? $diagnosis->disc_left : '') }}" name="disc_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">VCDR</td>
                  <td><input type="text" value="{{ old('vcdr_right', isset($diagnosis) ? $diagnosis->vcdr_right : '') }}" name="vcdr_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('vcdr_left', isset($diagnosis) ? $diagnosis->vcdr_left : '') }}" name="vcdr_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">MACULA</td>
                  <td><input type="text" value="{{ old('macula_right', isset($diagnosis) ? $diagnosis->macula_right : '') }}" name="macula_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('macula_left', isset($diagnosis) ? $diagnosis->macula_left : '') }}" name="macula_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">RETINA</td>
                  <td><input type="text" value="{{ old('retina_right', isset($diagnosis) ? $diagnosis->retina_right : '') }}" name="retina_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('retina_left', isset($diagnosis) ? $diagnosis->retina_left : '') }}" name="retina_left" class="form-control"></td>
                </tr>
                <tr>
                  <td width="70%">VESSELS</td>
                  <td><input type="text" value="{{ old('vessels_right', isset($diagnosis) ? $diagnosis->vessels_right : '') }}" name="vessels_right" class="form-control"></td>
                  <td><input type="text" value="{{ old('vessels_left', isset($diagnosis) ? $diagnosis->vessels_left : '') }}" name="vessels_left" class="form-control"></td>
                </tr>
                </tbody>
              </table>
            </div>
...
<script>
  jQuery(document).ready(function($) {
    ...
    // Initialize EasyEditor for comments textarea
    try {
      new EasyEditor('#editor', {
        buttons: ['bold', 'italic', 'underline', 'h2', 'h3', 'p', 'ul', 'ol', 'link']
      });
    } catch (e) {
      console.warn('EasyEditor initialization failed:', e);
    }
