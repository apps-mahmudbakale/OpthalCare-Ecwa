    ...
    <div class="card mb-4">
      <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto user-avatar user-avatar-xl">
          <img
            src="{{ $admission->patient->gender == 'Male' ? asset('assets/img/user-male-circle.png') : asset('assets/img/user-female-circle.png') }}"
            ...
            <div class="user-profile-info">
              ...
              <ul
                ...
                <li class="list-inline-item d-flex gap-1">
                  ...
                  <span class="badge bg-primary">Updated at: {{ $admission->patient->updated_at->diffForHumans() }}</span>
                </li>
              </ul>
            </div>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu" style="">
                <li><a class="dropdown-item" href="{{route('app.patients.edit', $admission->patient->id)}}">Edit Patient</a></li>
                ...
                <li><a class="dropdown-item" data-request-url="{{ route('app.patient.fund.wallet', $admission->patient->id) }}"
