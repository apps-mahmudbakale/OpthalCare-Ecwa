...
return new class extends Migration
{
  ...
  {
    Schema::create('refraction_card_subjective_refraction', function (Blueprint $table) {
      $table->id();
      ...
      $table->string('va2_right')->nullable();
      $table->string('va2_left')->nullable();
      $table->timestamps();
    });
  }
  ...
  {
    Schema::dropIfExists('refraction_card_subjective_refraction');
  }
};
